                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="view-product">
                                <img src="<?php echo Product::getImage($product['id']); ?>" width="200" height="337" alt="" />
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <p><b>Издательство:</b> <?php echo $product['publishing_house']; ?></p>
                                <p><b>Колличество страниц:</b> <?php echo $product['page_number']; ?></p>
                                <p><b>Год издания:</b> <?php echo $product['year']; ?></p>
