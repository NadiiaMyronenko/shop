                ...
                <div class="col-lg-4">
                    <div class="login-form">
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <p>Издательство</p>
                            <input type="text" name="publishing_house" placeholder="" value="<?php echo $product['publishing_house']; ?>">

                            <p>Колличество страниц</p>
                            <input type="text" name="page_number" placeholder="" value="<?php echo $product['page_number']; ?>">

                            <p>Год издания</p>
                            <input type="text" name="year" placeholder="" value="<?php echo $product['year']; ?>">

                            <p>Изображение товара</p>
                            <img src="<?php echo Product::getImage($product['id']); ?>" width="255" height="237" alt="" />
