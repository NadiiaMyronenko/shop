                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i> book.loc@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li>
                                <form name="search" method="post" action="/product/search/" class="find searchform">
                                    <input type="search" name="query" placeholder="Поиск" style="color: black">
